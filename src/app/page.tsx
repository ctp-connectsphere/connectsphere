      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Connect with fellow students and find your perfect study partners on
            campus. Join thousands of students who are already using Campus
            Connect to enhance their learning experience.
          </p>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
              Connect with students who share your courses and study
              preferences.
            </p>
          </div>

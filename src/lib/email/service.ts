...
export async function sendVerificationEmail(
  ...
  const subject = 'Verify Your ConnectSphere Email';
  ...
  const html = `
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>Thank you for registering with ConnectSphere! To complete your registration and start finding study partners, please verify your email address by clicking the button below:</p>
        ...
        <p>Or copy and paste this link into your browser:</p>
        <p style="word-break: break-all; background: #f5f5f5; padding: 10px; border-radius: 4px; font-family: monospace;">${verificationLink}</p>
        
        <div class="warning">
          <strong>Important:</strong> This verification link will expire in 24 hours. After verification, you'll be able to log in and start connecting with fellow students.
        </div>
        
        <p>If you didn't create a ConnectSphere account, please ignore this email.</p>
        
        <p>Welcome to ConnectSphere!<br>The ConnectSphere Team</p>
      </div>
  ...
  const text = `
Verify Your Email Address - ConnectSphere

Hello ${userName},

Thank you for registering with ConnectSphere! To complete your registration, please verify your email address by visiting this link:

${verificationLink}

This verification link will expire in 24 hours.

If you didn't create a ConnectSphere account, please ignore this email.

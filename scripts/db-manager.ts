...
import { prisma, checkDatabaseConnection, getDatabaseHealth } from '../src/lib/db/connection'
...
const commands: Command[] = [
  {
    ...
    action: async () => {
      ...
      console.log('📊 Database Status:', JSON.stringify(dbHealth, null, 2))
  ...
  
  {
    ...
    action: async () => {
      ...
      try {
        ...
        console.log(`   Memory Usage: ${JSON.stringify(redisStats.memoryUsage, null, 2)}`)

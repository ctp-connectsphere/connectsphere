...
async function debugRedis() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        '✅ SET/GET test:',
        value === 'Hello Redis!' ? 'Success' : 'Failed'
      );
    ...
    try {
      ...
      console.log(
        '✅ INCR test:',
        count1 === 1 && count2 === 2 ? 'Success' : 'Failed',
        `(${count1}, ${count2})`
      );
    ...
    try {
      ...
      console.log(
        '✅ Match caching:',
        JSON.stringify(cached) === JSON.stringify(testMatches)
          ? 'Success'
          : 'Failed'
      );
    ...
    try {
      ...
      console.log(
        '✅ Profile caching:',
        JSON.stringify(cached) === JSON.stringify(testProfile)
          ? 'Success'
          : 'Failed'
      );
    ...
    try {
      ...
      console.log(
        '✅ Rate limiting:',
        rateLimit?.allowed ? 'Success' : 'Failed',
